...
(function () {
  ...
  var Codebird = (function () {
    function Codebird() {
       ...
       */
      this._use_proxy = true; //typeof navigator !== "undefined" && typeof navigator.userAgent !== "undefined";
    ...
    _createClass(Codebird, [{
      ...
      value: function oauth2_token(callback) {
        ...
        xml.setRequestHeader((this._use_proxy ? "X-" : "") + "Authorization", "Application-only");
